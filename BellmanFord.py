...
if __name__ == "__main__":
    ...
    routing.load_graph(r"C:\Users\danie\OneDrive\Desktop\C++\Projects\BellmanFord\roadNet-PA.txt")
    
    # Find paths from Node 0
    distances, predecessors = routing.find_shortest_paths(0)
